...
var format_SARANAIBADAH_5 = new ol.format.GeoJSON();
var features_SARANAIBADAH_5 = format_SARANAIBADAH_5.readFeatures(json_SARANAIBADAH_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SARANAIBADAH_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SARANAIBADAH_5.addFeatures(features_SARANAIBADAH_5);
var lyr_SARANAIBADAH_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_SARANAIBADAH_5, 
                style: style_SARANAIBADAH_5,
                popuplayertitle: 'SARANAIBADAH',
                interactive: true,
                title: '<img src="styles/legend/SARANAIBADAH_5.png" /> SARANAIBADAH'
            });
var format_PEMERINTAHAN_6 = new ol.format.GeoJSON();
var features_PEMERINTAHAN_6 = format_PEMERINTAHAN_6.readFeatures(json_PEMERINTAHAN_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PEMERINTAHAN_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PEMERINTAHAN_6.addFeatures(features_PEMERINTAHAN_6);
var lyr_PEMERINTAHAN_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PEMERINTAHAN_6, 
                style: style_PEMERINTAHAN_6,
                popuplayertitle: 'PEMERINTAHAN',
                interactive: true,
                title: '<img src="styles/legend/PEMERINTAHAN_6.png" /> PEMERINTAHAN'
            });
...
var format_BATASDESAKETELENG_9 = new ol.format.GeoJSON();
var features_BATASDESAKETELENG_9 = format_BATASDESAKETELENG_9.readFeatures(json_BATASDESAKETELENG_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_BATASDESAKETELENG_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_BATASDESAKETELENG_9.addFeatures(features_BATASDESAKETELENG_9);
var lyr_BATASDESAKETELENG_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_BATASDESAKETELENG_9, 
                style: style_BATASDESAKETELENG_9,
                popuplayertitle: 'BATAS DESA KETELENG',
                interactive: false,
                title: '<img src="styles/legend/BATASDESAKETELENG_9.png" /> BATAS DESA KETELENG'
            });
var format_PADUKUHAN_10 = new ol.format.GeoJSON();
var features_PADUKUHAN_10 = format_PADUKUHAN_10.readFeatures(json_PADUKUHAN_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PADUKUHAN_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PADUKUHAN_10.addFeatures(features_PADUKUHAN_10);
var lyr_PADUKUHAN_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PADUKUHAN_10, 
                style: style_PADUKUHAN_10,
                popuplayertitle: 'PADUKUHAN',
                interactive: true,
                title: '<img src="styles/legend/PADUKUHAN_10.png" /> PADUKUHAN'
            });
var format_RTRW_11 = new ol.format.GeoJSON();
var features_RTRW_11 = format_RTRW_11.readFeatures(json_RTRW_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RTRW_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RTRW_11.addFeatures(features_RTRW_11);
var lyr_RTRW_11 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RTRW_11, 
                style: style_RTRW_11,
                popuplayertitle: 'RT/RW',
                interactive: true,
                title: '<img src="styles/legend/RTRW_11.png" /> RT/RW'
            });

lyr_GoogleSatellite_0.setVisible(true);lyr_KONTURKETINGGIANmdpl_1.setVisible(false);lyr_SUNGAI_2.setVisible(false);lyr_JALAN_3.setVisible(false);lyr_KONTURKETINGGIANmdpl_4.setVisible(false);lyr_SARANAIBADAH_5.setVisible(true);lyr_PEMERINTAHAN_6.setVisible(true);lyr_PENDIDIKAN_7.setVisible(true);lyr_KESEHATAN_8.setVisible(true);lyr_BATASDESAKETELENG_9.setVisible(true);lyr_PADUKUHAN_10.setVisible(true);lyr_RTRW_11.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_KONTURKETINGGIANmdpl_1,lyr_SUNGAI_2,lyr_JALAN_3,lyr_KONTURKETINGGIANmdpl_4,lyr_SARANAIBADAH_5,lyr_PEMERINTAHAN_6,lyr_PENDIDIKAN_7,lyr_KESEHATAN_8,lyr_BATASDESAKETELENG_9,lyr_PADUKUHAN_10,lyr_RTRW_11];
...
lyr_SARANAIBADAH_5.set('fieldAliases', {'NAMOBJ': 'NAMOBJ', 'LUAS': 'LUAS', 'FGSIBD': 'FGSIBD', 'FCODE': 'FCODE', 'REMARK': 'REMARK', 'SRS_ID': 'SRS_ID', 'LCODE': 'LCODE', 'METADATA': 'METADATA', });
lyr_PEMERINTAHAN_6.set('fieldAliases', {'NAMOBJ': 'NAMOBJ', 'FGSGOV': 'FGSGOV', 'LUAS': 'LUAS', 'FCODE': 'FCODE', 'REMARK': 'REMARK', 'SRS_ID': 'SRS_ID', 'LCODE': 'LCODE', 'METADATA': 'METADATA', });
lyr_PENDIDIKAN_7.set('fieldAliases', {'NAMOBJ': 'NAMOBJ', 'LUAS': 'LUAS', 'KATPDK': 'KATPDK', 'JLPDDK': 'JLPDDK', 'FGGPDK': 'FGGPDK', 'REMARK': 'REMARK', 'FCODE': 'FCODE', 'SRS_ID': 'SRS_ID', 'LCODE': 'LCODE', 'METADATA': 'METADATA', 'JJGPDF': 'JJGPDF', 'JNSPDL': 'JNSPDL', });
lyr_KESEHATAN_8.set('fieldAliases', {'NAMOBJ': 'NAMOBJ', 'LUAS': 'LUAS', 'REMARK': 'REMARK', 'TIPSHT': 'TIPSHT', 'FCODE': 'FCODE', 'SRS_ID': 'SRS_ID', 'LCODE': 'LCODE', 'METADATA': 'METADATA', 'FSKADD': 'FSKADD', });
lyr_BATASDESAKETELENG_9.set('fieldAliases', {'KDPPUM': 'KDPPUM', 'NAMOBJ': 'NAMOBJ', 'REMARK': 'REMARK', 'KDPBPS': 'KDPBPS', 'FCODE': 'FCODE', 'LUASWH': 'LUASWH', 'UUPP': 'UUPP', 'SRS_ID': 'SRS_ID', 'LCODE': 'LCODE', 'METADATA': 'METADATA', 'KDEBPS': 'KDEBPS', 'KDEPUM': 'KDEPUM', 'KDCBPS': 'KDCBPS', 'KDCPUM': 'KDCPUM', 'KDBBPS': 'KDBBPS', 'KDBPUM': 'KDBPUM', 'WADMKD': 'WADMKD', 'WIADKD': 'WIADKD', 'WADMKC': 'WADMKC', 'WIADKC': 'WIADKC', 'WADMKK': 'WADMKK', 'WIADKK': 'WIADKK', 'WADMPR': 'WADMPR', 'WIADPR': 'WIADPR', 'TIPADM': 'TIPADM', 'SHAPE_Leng': 'SHAPE_Leng', 'SHAPE_Area': 'SHAPE_Area', });
lyr_PADUKUHAN_10.set('fieldAliases', {'NAMOBJ': 'NAMOBJ', 'FCODE': 'FCODE', 'REMARK': 'REMARK', 'SRS_ID': 'SRS_ID', 'LCODE': 'LCODE', 'METADATA': 'METADATA', 'SHAPE_Leng': 'SHAPE_Leng', 'SHAPE_Area': 'SHAPE_Area', });
lyr_RTRW_11.set('fieldAliases', {'id': 'id', 'RT': 'RT', 'RW': 'RW', });
...
lyr_SARANAIBADAH_5.set('fieldImages', {'NAMOBJ': 'TextEdit', 'LUAS': 'TextEdit', 'FGSIBD': 'TextEdit', 'FCODE': 'TextEdit', 'REMARK': 'TextEdit', 'SRS_ID': 'TextEdit', 'LCODE': 'TextEdit', 'METADATA': 'TextEdit', });
lyr_PEMERINTAHAN_6.set('fieldImages', {'NAMOBJ': 'TextEdit', 'FGSGOV': 'TextEdit', 'LUAS': 'TextEdit', 'FCODE': 'TextEdit', 'REMARK': 'TextEdit', 'SRS_ID': 'TextEdit', 'LCODE': 'TextEdit', 'METADATA': 'TextEdit', });
lyr_PENDIDIKAN_7.set('fieldImages', {'NAMOBJ': 'TextEdit', 'LUAS': 'TextEdit', 'KATPDK': 'TextEdit', 'JLPDDK': 'TextEdit', 'FGGPDK': 'TextEdit', 'REMARK': 'TextEdit', 'FCODE': 'TextEdit', 'SRS_ID': 'TextEdit', 'LCODE': 'TextEdit', 'METADATA': 'TextEdit', 'JJGPDF': 'TextEdit', 'JNSPDL': 'TextEdit', });
lyr_KESEHATAN_8.set('fieldImages', {'NAMOBJ': 'TextEdit', 'LUAS': 'TextEdit', 'REMARK': 'TextEdit', 'TIPSHT': 'TextEdit', 'FCODE': 'TextEdit', 'SRS_ID': 'TextEdit', 'LCODE': 'TextEdit', 'METADATA': 'TextEdit', 'FSKADD': 'TextEdit', });
lyr_BATASDESAKETELENG_9.set('fieldImages', {'KDPPUM': 'TextEdit', 'NAMOBJ': 'TextEdit', 'REMARK': 'TextEdit', 'KDPBPS': 'TextEdit', 'FCODE': 'TextEdit', 'LUASWH': 'TextEdit', 'UUPP': 'TextEdit', 'SRS_ID': 'TextEdit', 'LCODE': 'TextEdit', 'METADATA': 'TextEdit', 'KDEBPS': 'TextEdit', 'KDEPUM': 'TextEdit', 'KDCBPS': 'TextEdit', 'KDCPUM': 'TextEdit', 'KDBBPS': 'TextEdit', 'KDBPUM': 'TextEdit', 'WADMKD': 'TextEdit', 'WIADKD': 'TextEdit', 'WADMKC': 'TextEdit', 'WIADKC': 'TextEdit', 'WADMKK': 'TextEdit', 'WIADKK': 'TextEdit', 'WADMPR': 'TextEdit', 'WIADPR': 'TextEdit', 'TIPADM': 'TextEdit', 'SHAPE_Leng': 'TextEdit', 'SHAPE_Area': 'TextEdit', });
lyr_PADUKUHAN_10.set('fieldImages', {'NAMOBJ': 'TextEdit', 'FCODE': 'TextEdit', 'REMARK': 'TextEdit', 'SRS_ID': 'TextEdit', 'LCODE': 'TextEdit', 'METADATA': 'TextEdit', 'SHAPE_Leng': 'TextEdit', 'SHAPE_Area': 'TextEdit', });
lyr_RTRW_11.set('fieldImages', {'id': 'TextEdit', 'RT': 'TextEdit', 'RW': 'TextEdit', });
...
lyr_SARANAIBADAH_5.set('fieldLabels', {'NAMOBJ': 'hidden field', 'LUAS': 'hidden field', 'FGSIBD': 'hidden field', 'FCODE': 'hidden field', 'REMARK': 'no label', 'SRS_ID': 'hidden field', 'LCODE': 'hidden field', 'METADATA': 'hidden field', });
lyr_PEMERINTAHAN_6.set('fieldLabels', {'NAMOBJ': 'hidden field', 'FGSGOV': 'hidden field', 'LUAS': 'hidden field', 'FCODE': 'hidden field', 'REMARK': 'no label', 'SRS_ID': 'hidden field', 'LCODE': 'hidden field', 'METADATA': 'hidden field', });
lyr_PENDIDIKAN_7.set('fieldLabels', {'NAMOBJ': 'no label', 'LUAS': 'hidden field', 'KATPDK': 'hidden field', 'JLPDDK': 'hidden field', 'FGGPDK': 'hidden field', 'REMARK': 'hidden field', 'FCODE': 'hidden field', 'SRS_ID': 'hidden field', 'LCODE': 'hidden field', 'METADATA': 'hidden field', 'JJGPDF': 'hidden field', 'JNSPDL': 'hidden field', });
lyr_KESEHATAN_8.set('fieldLabels', {'NAMOBJ': 'no label', 'LUAS': 'hidden field', 'REMARK': 'hidden field', 'TIPSHT': 'hidden field', 'FCODE': 'hidden field', 'SRS_ID': 'hidden field', 'LCODE': 'hidden field', 'METADATA': 'hidden field', 'FSKADD': 'hidden field', });
lyr_BATASDESAKETELENG_9.set('fieldLabels', {'KDPPUM': 'hidden field', 'NAMOBJ': 'hidden field', 'REMARK': 'hidden field', 'KDPBPS': 'hidden field', 'FCODE': 'hidden field', 'LUASWH': 'hidden field', 'UUPP': 'hidden field', 'SRS_ID': 'hidden field', 'LCODE': 'hidden field', 'METADATA': 'hidden field', 'KDEBPS': 'hidden field', 'KDEPUM': 'hidden field', 'KDCBPS': 'hidden field', 'KDCPUM': 'hidden field', 'KDBBPS': 'hidden field', 'KDBPUM': 'hidden field', 'WADMKD': 'hidden field', 'WIADKD': 'hidden field', 'WADMKC': 'hidden field', 'WIADKC': 'hidden field', 'WADMKK': 'hidden field', 'WIADKK': 'hidden field', 'WADMPR': 'hidden field', 'WIADPR': 'hidden field', 'TIPADM': 'hidden field', 'SHAPE_Leng': 'hidden field', 'SHAPE_Area': 'hidden field', });
lyr_PADUKUHAN_10.set('fieldLabels', {'NAMOBJ': 'no label', 'FCODE': 'hidden field', 'REMARK': 'hidden field', 'SRS_ID': 'hidden field', 'LCODE': 'hidden field', 'METADATA': 'hidden field', 'SHAPE_Leng': 'hidden field', 'SHAPE_Area': 'hidden field', });
lyr_RTRW_11.set('fieldLabels', {'id': 'hidden field', 'RT': 'no label', 'RW': 'no label', });
lyr_RTRW_11.on('precompose', function(evt) {
